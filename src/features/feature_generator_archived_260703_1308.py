...
COLS_COATING_DRY_TEMPERATURE = {
    'X_Cathode_PV_Slitting_W002200_N': "Dryer [In] Lamp Temperature (Top) PV",
    'X_Cathode_PV_Slitting_W002201_N' : "Dryer [In] Dry Temperature (Top) PV",
    'X_Cathode_PV_Slitting_W002202_N' : "Dryer [In] Dry Temperature (Back) PV",
    'X_Cathode_PV_Slitting_W002203_N' : "Dryer [Mid] Lamp Temperature (Top) PV",
    'X_Cathode_PV_Slitting_W002204_N' : "Dryer [Mid] Dry Temperature (Top) PV",
    'X_Cathode_PV_Slitting_W002205_N' : "Dryer [Mid] Dry Temperature (Back) PV",
    'X_Cathode_PV_Slitting_W002206_N' : "Dryer [Out] Lamp Temperature (Top) PV",
    'X_Cathode_PV_Slitting_W002207_N' : "Dryer [Out] Dry Temperature (Top) PV",
    'X_Cathode_PV_Slitting_W002208_N' : "Dryer [Out] Dry Temperature (Back) PV",
    'X_Anode_PV_Slitting_W002200_N': "Dryer [In] Lamp Temperature (Top) PV",
    'X_Anode_PV_Slitting_W002201_N' : "Dryer [In] Dry Temperature (Top) PV",
    'X_Anode_PV_Slitting_W002202_N' : "Dryer [In] Dry Temperature (Back) PV",
    'X_Anode_PV_Slitting_W002203_N' : "Dryer [Mid] Lamp Temperature (Top) PV",
    'X_Anode_PV_Slitting_W002204_N' : "Dryer [Mid] Dry Temperature (Top) PV",
    'X_Anode_PV_Slitting_W002205_N' : "Dryer [Mid] Dry Temperature (Back) PV",
    'X_Anode_PV_Slitting_W002206_N' : "Dryer [Out] Lamp Temperature (Top) PV",
    'X_Anode_PV_Slitting_W002207_N' : "Dryer [Out] Dry Temperature (Top) PV",
    'X_Anode_PV_Slitting_W002208_N' : "Dryer [Out] Dry Temperature (Back) PV",
}

COLS_COATING_FAN = {
    'X_Anode_PV_Slitting_W002211_N': "Dryer Exhaust Fan Output (In)",
    'X_Cathode_PV_Slitting_W002211_N': "Dryer Exhaust Fan Output (Out)",
}

COLS_LIINE_SPEED = [
    'X_Cathode_PV_Coating_D0002500_N',
    'X_Anode_PV_Coating_D0002500_N'
]

COLS_ROLL_PRESSING_THICKNESS = {
        "X_Anode_PV_Roll Pressing_W004E22_N": "두께_M수_1차",
        'X_Anode_PV_Roll Pressing_W004E30_N': "1번 두께 평균_1차",
        'X_Anode_PV_Roll Pressing_W004E31_N': "2번 두께 평균_1차",
        'X_Anode_PV_Roll Pressing_W004E32_N': "3번 두께 평균_1차",
        'X_Anode_PV_Roll Pressing_W004E33_N': "4번 두께 평균_1차",
        'X_Anode_PV_Roll Pressing_W004E62_N': "두께_M수_2차",
        'X_Anode_PV_Roll Pressing_W004E70_N': "1번 두께 평균_2차",
        'X_Anode_PV_Roll Pressing_W004E71_N': "2번 두께 평균_2차",
        'X_Anode_PV_Roll Pressing_W004E72_N': "3번 두께 평균_2차",
        'X_Anode_PV_Roll Pressing_W004E73_N': "4번 두께 평균_2차",

        'X_Cathode_PV_Roll Pressing_W004E22_N' : "두께_M수_1차",
        'X_Cathode_PV_Roll Pressing_W004E30_N': "1번 두께 평균_1차",
        'X_Cathode_PV_Roll Pressing_W004E31_N': "2번 두께 평균_1차",
        'X_Cathode_PV_Roll Pressing_W004E32_N': "3번 두께 평균_1차",
        'X_Cathode_PV_Roll Pressing_W004E33_N': "4번 두께 평균_1차",
        'X_Cathode_PV_Roll Pressing_W004E62_N': "두께_M수_2차",
        'X_Cathode_PV_Roll Pressing_W004E70_N': "1번 두께 평균_2차",
        'X_Cathode_PV_Roll Pressing_W004E71_N': "2번 두께 평균_2차",
        'X_Cathode_PV_Roll Pressing_W004E72_N': "3번 두께 평균_2차",
        'X_Cathode_PV_Roll Pressing_W004E73_N': "4번 두께 평균_2차",
}

COLS_SLITTING_THICKNESS = {
    'X_Anode_PV_Slitting_W001520_N' : "Thickness Average (DS)",
    'X_Anode_PV_Slitting_W001522_N' : "Thickness Average (OS)",
    'X_Cathode_PV_Slitting_W001520_N' : "Thickness Average (DS)",
    'X_Cathode_PV_Slitting_W001522_N' : "Thickness Average (OS)",
}
...
class FeatureGenerator:
    ...
    def _dv_30(self, data:pd.DataFrame) -> pd.DataFrame:
        ...
        data_transformed[f"{prefix}_Room Temp Aging #01 SEI"] = (
            data_transformed['X_NFF_Room Temp Aging #01_Charge Time(mins)']
            * data_transformed['X_NFF_Room Temp Aging #01_Average Temperature']
        )
        data_transformed[f"{prefix}_Room Temp Aging #02 SEI"] = (
            data_transformed['X_NFF_Room Temp Aging #02_Charge Time(mins)']
            * data_transformed['X_NFF_Room Temp Aging #02_Average Temperature']
        )
        data_transformed[f"{prefix}_Room Temp Aging #03 SEI"] = (
            data_transformed['X_NFF_Room Temp Aging #03_Charge Time(mins)']
            * data_transformed['X_NFF_Room Temp Aging #03_Average Temperature']
        )
        data_transformed[f"{prefix}_Room Temp Aging #04 SEI"] = (
            data_transformed['X_NFF_Room Temp Aging #04_Charge Time(mins)']
            * data_transformed['X_NFF_Room Temp Aging #04_Average Temperature']
        )
        data_transformed[f"{prefix}_Room Temp Aging #05 SEI"] = (
            data_transformed['X_NFF_Room Temp Aging #05_Charge Time(mins)']
            * data_transformed['X_NFF_Room Temp Aging #05_Average Temperature']
        )
        data_transformed[f"{prefix}_Room Temp Aging #06 SEI"] = (
            data_transformed['X_NFF_Room Temp Aging #06_Charge Time(mins)']
            * data_transformed['X_NFF_Room Temp Aging #06_Average Temperature']
        )
        data_transformed[f"{prefix}_Room Temp Aging #07 SEI"] = (
            data_transformed['X_NFF_Room Temp Aging #07_Charge Time(mins)']
            * data_transformed['X_NFF_Room Temp Aging #07_Average Temperature']
        )

        data_transformed[f"{prefix}_High Temp Aging #01 SEI"] = (
            data_transformed['X_NFF_High Temp Aging #01_Charge Time(mins)']
            * data_transformed['X_NFF_High Temp Aging #01_Average Temperature']
        )
        data_transformed[f"{prefix}_High Temp Aging #02 SEI"] = (
            data_transformed['X_NFF_High Temp Aging #02_Charge Time(mins)']
            * data_transformed['X_NFF_High Temp Aging #02_Average Temperature']
        )
    ...
    def _dv_42(self, data:pd.DataFrame) -> pd.DataFrame:
        ...
        col_vis = 'Y_Anode_GJJJ_Mixing_점도_Inspection Measure Value'
        col_solid = 'Y_Anode_GJJJ_Mixing_고형분_Inspection Measure Value'
        ...
        col_vis = 'Y_Cathode_GJJJ_Mixing_점도_Inspection Measure Value'
        col_solid = 'Y_Cathode_GJJJ_Mixing_고형분_Inspection Measure Value'
    ...
    def _dv_56(self, data:pd.DataFrame) -> pd.DataFrame:
        ...
        col_1 = data["X_Cathode_IQC_금속이물_Cu-Zn"]
        col_2 = data["X_Cathode_IQC_금속이물_Fe-Cr"]
        col_3= data['X_Cathode_IQC_자성이물']

        data_transformed[f"{prefix}_Cathode_이물 총합"] = col_1 + col_2 + col_3

        
        col_1 = data["X_Anode_IQC_금속이물_Cu-Zn"]
        col_2 = data["X_Anode_IQC_금속이물_Fe-Cr"]
        col_3= data['X_Anode_IQC_자성이물']
    ...
    def _dv_83(self, data:pd.DataFrame) -> pd.DataFrame:
        ...
        data_transformed[f"{prefix}__음극 x 양극 Coating 로딩"] = (
            data_transformed['X_Anode_LQC_Coating_로딩']
            * data_transformed['X_Cathode_LQC_Coating_로딩']
        )
        data_transformed[f"{prefix}__음극 x 양극 Coating 총로딩량1"] = (
            data_transformed['X_Anode_LQC_Coating_로딩_총 로딩량1']
            * data_transformed['X_Cathode_LQC_Coating_로딩_총 로딩량1']   
        )
        data_transformed[f"{prefix}__음극 x 양극 Coating 총로딩량2"] = (
            data_transformed['X_Anode_LQC_Coating_로딩_총 로딩량2']
            * data_transformed['X_Cathode_LQC_Coating_로딩_총 로딩량2']   
        )
        data_transformed[f"{prefix}__음극 x 양극 Roll Pressing 로딩"] = (
            data_transformed['X_Anode_LQC_Roll Pressing_로딩']
            * data_transformed['X_Cathode_LQC_Roll Pressing_로딩']
        )
        data_transformed[f"{prefix}__음극 x 양극 Roll Pressing 총로딩량1"] = (
            data_transformed['X_Anode_LQC_Roll Pressing_로딩_총 로딩량1']
            * data_transformed['X_Cathode_LQC_Roll Pressing_로딩_총 로딩량1']   
        )
        data_transformed[f"{prefix}__음극 x 양극 Roll Pressing 총로딩량2"] = (
            data_transformed['X_Anode_LQC_Roll Pressing_로딩_총 로딩량2']
            * data_transformed['X_Cathode_LQC_Roll Pressing_로딩_총 로딩량2']   
        )
    ...
    def _dv_84(self, data:pd.DataFrame) -> pd.DataFrame:
        ...
        data_transformed[f"{prefix}__Anode 점도 x 라인 속도"] = (
            data_transformed['Y_Anode_GJJJ_Mixing_점도_Inspection Measure Value']
            * data_transformed['X_PV_RollPress_Anode_D0006004_F_DN_Mean']
        )
        data_transformed[f"{prefix}__Cathode 점도 x 라인 속도"] = (
            data_transformed['Y_Cathode_GJJJ_Mixing_점도_Inspection Measure Value']
            * data_transformed['X_PV_RollPress_Cathode_D0006004_F_DN_Mean']
        )
